...
class Command(BaseCommand):
    help = 'Loads trained models'

    def handle(self, *args, **options):
        pickles_path = os.path.join(settings.BASE_DIR, "pickles")
        ...
        tm_tfidf, _ = TrainedModel.objects.get_or_create(name='tfidf')
        tm_clf, _ = TrainedModel.objects.get_or_create(name='clf')
